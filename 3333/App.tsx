...
import { BookOpen, Activity, LayoutGrid, Video, Users, Image as ImageIcon, ChevronDown, Monitor, Sidebar, LineChart, Settings, X, Key, Save, CheckCircle2, Zap, Download, Upload, Clipboard, Trash2, RotateCcw, Shield } from 'lucide-react';
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] flex items-center justify-center p-4 animate-in fade-in duration-200">
              <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in-95 flex flex-col max-h-[90vh]">
                  ...
                  <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
                      ...
                      >
                         {keySaved ? <CheckCircle2 className="w-4 h-4" /> : <Save className="w-4 h-4" />}
                         {keySaved ? '配置已保存' : '保存配置'}
                      </button>
                  </div>
              </div>
